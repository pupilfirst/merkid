...
class UserDashboard < Administrate::BaseDashboard
  ...
  ATTRIBUTE_TYPES = {
    ...
    email: Field::String,
    dob: Field::Date.with_options(transform_on_export: -> (field) { field.data&.iso8601 }),
    application_form: Field::String.with_options(searchable: false),
    status: Field::String,
    task_revealed_at: Field::DateTime.with_options(transform_on_export: -> (field) { field.data&.iso8601 }),
    ...
    course: Field::String,
    terms_agreed_at: Field::DateTime.with_options(transform_on_export: -> (field) { field.data&.iso8601 }),
    discarded_at: Field::DateTime.with_options(transform_on_export: -> (field) { field.data&.iso8601 }),
    task_submitted_at: Field::DateTime.with_options(transform_on_export: -> (field) { field.data&.iso8601 }),
    submission_receipt_emailed_at: Field::DateTime.with_options(transform_on_export: -> (field) { field.data&.iso8601 }),
    task_reviewed_at: Field::DateTime.with_options(transform_on_export: -> (field) { field.data&.iso8601 }),
